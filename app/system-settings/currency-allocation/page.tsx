...
export default function CurrencyManagementPage() {
  ...
  return (
    <DashboardLayout>
      <div className="">
        <div className=" min-w-[1600px] mx-auto bg-white border rounded-md shadow-sm overflow-x-auto">
          <div className="px-4 py-4 border-b flex items-center justify-between gap-4">
            ...
            <table className="min-w-full text-sm border-collapse table-auto">
              <thead>
                <tr className="bg-gray-100 text-left">
                  ...
                  <th className="p-2 border">Agent Information</th>
                  <th className="p-2 border">Contract Address</th>
                  <th className="p-2 border">state</th>
                  <th className="p-2 border">Deposit</th>
                  <th className="p-2 border">Withdrawal</th>
                  <th className="p-2 border">Fee types</th>
                  <th className="p-2 border">
                    Cryptocurrency transaction fees
                  </th>
                  <th className="p-2 border">Contract fees</th>
                  <th className="p-2 border">Default channel</th>
              ...
              <tbody>
                {filtered.map((row) => (
                  <tr key={row.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-2 border">{row.feeTypes}</td>
                    <td className="p-2 border">{row.cryptoTransFee}</td>
                    <td className="p-2 border">{row.contractFees}</td>
                    <td className="p-2 border">
                      {row.defaultChannel ? (
                    ...
                    <td className="p-2 border flex gap-2">
                      ...
                      <button
                        className="px-2 py-1 text-xs bg-red-50 border border-red-200 text-red-600 rounded"
                        onClick={() => {
